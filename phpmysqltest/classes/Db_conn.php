...
class DatabaseConn {	
  ...
  public function dbOpen(){
    ...
    try {
      ...
      $dbHost = 'localhost';
      $dbName = 'obrinkerhoff';//this will be your WCC username
      $dbUsr = 'obrinkerhoff';//this will be your WCC username
      $dbPass = 'fvT70Lr70Xyw2DI';//this will be the password found in the video.
